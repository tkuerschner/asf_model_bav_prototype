...
grp_path_bp <- ggplot() +
  ...
  new_scale_color() +
  geom_point(data = disp_event, aes(disperser_group_x, disperser_group_y, color = as.factor(disperser_id)),size = 1.5)+
  geom_path(data = disp_event, aes(disperser_group_x, disperser_group_y, color =  as.factor(disperser_id)),size = 1.5)+
