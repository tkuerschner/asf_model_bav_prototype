...
```
```{r data load}
# Function to read BSON file
read_bson_file <- function(file_path) {
  # Open the BSON file
  bson_data <- readBin(file_path, "raw", file.info(file_path)$size)
  
  # Convert BSON to JSON
  json_data <- bson::bson_to_json(bson_data)
  
  # Parse JSON to a data frame or list
...
# Usage
interaction_layer_data <- read_bson_file("./output/all_interaction_layer.bson")

# View the data
print(interaction_layer_data)
...
write.csv(gr2, file = "./R/asf_bavaria_analysis/group1.csv")
...
write.csv(gr2, file = "./R/asf_bavaria_analysis/group23.csv")
...
write.csv(gr2, file = "./R/asf_bavaria_analysis/group51.csv")
